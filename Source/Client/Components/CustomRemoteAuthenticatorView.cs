...
public class CustomRemoteAuthenticatorView : RemoteAuthenticatorView
{
    ...
    {
        var loginUrl = this.Navigation.ToAbsoluteUri(this.ApplicationPaths.LogInPath);
        var registerUrl = this.Navigation.ToAbsoluteUri($"{this.ApplicationPaths.RemoteRegisterPath}?returnUrl={loginUrl}");
