...
using LegendaryTelegram.Server.Models.Account;
...
public class AccountController : Controller
{
    ...
    {
        EnsureDatabaseCreated(this.applicationDbContext);
        this.ViewData["ReturnUrl"] = returnUrl;
    ...
    public async Task<IActionResult> Register(RegisterViewModel model, string? returnUrl = null)
    {
        ...
        if (this.ModelState.IsValid)
        {
            ...
            if (result.Succeeded)
            {
                ...
                //await this.emailSender.SendEmailAsync(model.Email, "Confirm your account",
    ...
    public async Task<IActionResult> VerifyCode(string provider, bool rememberMe, string? returnUrl = null)
    {
        ...
        return user is null
            ? View("Error")
            : (IActionResult)View(new VerifyCodeViewModel { Provider = provider, ReturnUrl = returnUrl, RememberMe = rememberMe });
    }
